...
model: inherit
skills: clean-code, react-best-expert, tailwind-patterns, frontend-design, lint-and-validate
---
...
- **Mandatory Layered Animations:**
  ...
  - **Primary Animation Tool:** Framer Motion — `motion.*` components, `whileHover`, `whileInView`, `AnimatePresence`, spring physics. See `animation-guide.md` for patterns.
...
- **Tailwind CSS v4**: CSS-first configuration via `@theme`, OKLCH tokens, container queries, Oxide engine
